...
parser.add_argument('--dir', type=str, default="EMP-SSL-AdvTraining",
                    help='directory name (default: EMP-SSL-AdvTraining)')     
...
# Loading model
# PATH ='./one-epoch-AT/logs/EMP-SSL-Training/patchsim200_numpatch40_bs100_lr0.3_NONE/save_models_adv_wo_Normalization_8_cifar100_crop/22.pt'
